...
age_pop = etudiant.pop("age")
print(f"Q6: on a enlevé l'âge de l'étudiant, sa valeur était: {age_pop}")
...
print(f"Dans le terminal: Q7: Nous avons maintenant {len(etudiant)} paires clés valeurs.")